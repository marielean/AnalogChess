...
import numpy as np
import multiprocessing, concurrent.futures, time
# Configurable parameters
max_threads = 10 # corrispondente al numero di virtual cores del server 
num_matches_for_config = 3 # dovranno essere 50 o 100
...
configurations1 = [
    ...
    # AlphaBeta-AlphaBeta con differenti euristiche (uguale profondità e granularità)
    ['custom_heuristic_0', 'custom_heuristic_2', 'AlphaBeta', 'AlphaBeta', 2, 2, 1, 1]
]
...
print(f'Number of matches for each configuration: {num_matches_for_config}')
...
print(f'Start time (minutes): {minuti_totali}')
