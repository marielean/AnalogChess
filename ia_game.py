...
while not done:
    ...
    if not board.is_white_turn():
        ...
        if board.is_terminal():
            print(f"This is the end... Winner is {white if not board.is_white_turn() else black}/n")
            print(f"Turn number: {turn_number}/n")
            print(f"Algoritmo del giocatore usato: {white_ia_algorithm if not board.is_white_turn() else black_ia_algorithm}/n")
            print(f"Profondità del giocatore usato: {white_depth if not board.is_white_turn() else black_depth}/n")
            print(f"Euristica del giocatore usato: {white_heuristic.__name__ if not board.is_white_turn() else black_heuristic.__name__}/n")
            done = True
